  ...
  var DEFAULT_REALTOR_OBJECT_GROUPS = {
    ...
    apartments: [
      ...
      },
      {
        ...
        title: "Orbi Beach Tower 2+1",
        detailHref: "apartment.html",
        description:
          "Апартаменты 2+1 в Orbi Beach Tower. Адрес: Батуми, ул. Шерифа Химшиашвили, 57. 32 этаж, 70 м². Солнечная сторона с видом на море и парк имени Лех и Марии Качиньских. Качественный ремонт с современным дизайном. Престижный апарт-отель: первая береговая линия — около 50 м до моря, ресепшн и круглосуточная охрана. Развитая инфраструктура: казино Eclipse, ресторан G.Garden, ТРЦ Metro City, супермаркет Carrefour, кафе, бассейн, фитнес-центр, спортивные и детские площадки. Подходит для жизни и для сдачи в аренду. Просторная полностью укомплектованная квартира, светлые комнаты с панорамными окнами, вид на море с балкона. Цена $200 000 — уточняйте актуальность и условия сделки у менеджера.",
        priceGel: 540_000,
        priceKind: "fixed",
        geo: {
          address: "Батуми, ул. Шерифа Химшиашвили, 57",
      ...
      },
      {
        ...
        detailHref: "apartment.html",
        description:
          "Продаётся квартира-студия в жилом комплексе ELT RAINBOW (Радуга, ЭЛТ Квартал). Адрес: ул. Адлия, 2, Батуми. 12 этаж, 32,2 м². Рядом парк Лех и Марии Качинских и ТРЦ Metro City; до моря около 150 м. Хорошо подходит как для проживания, так и для сдачи в аренду. Чёрный каркас, газ, дом сдан — готова к ремонту. Дизайн-проект в подарок и скидка на ремонтные работы (условия уточняйте у менеджера). Развитая инфраструктура ELT квартала: кинотеатр, кафе и рестораны, аптеки, круглосуточные магазины, тренажёрный зал. Цена $39 000 (США). Юридическое сопровождение сделки — через агентство.",
        priceGel: 105_300,
        priceKind: "fixed",
        geo: {
      ...
      },
      {
        ...
        title: "Студия в STEPS",
        detailHref: "apartment.html",
        description:
          "Квартира-студия в жилом комплексе Steps Batumi. Без управления от Steps. Адрес: Батуми, ул. Григола Лорткипанидзе, 2б. 23 этаж, 31,6 м². Новый бульвар: рядом парк имени Лех и Марии Качиньских, ТРЦ Metro City. Новый жилой комплекс бизнес-класса — ресепшн и круглосуточная охрана. Инфраструктура: ботанический сад, бизнес-центр, ресторан, гостиница, парковка, детская площадка, бассейн, сауна, хаммам, кафе, тренажёрный зал. До моря около 150 м, 4 скоростных лифта с автономным питанием, противопожарные комнаты безопасности с подачей кислорода. Подходит для проживания и для сдачи в аренду. Просторная светлая студия с качественным ремонтом, мебелью и техникой, вид на горы и город, солнечная сторона. Цена $61 000 — уточняйте актуальность и условия сделки у менеджера.",
        priceGel: 164_700,
        priceKind: "fixed",
        geo: {
          address: "Батуми, ул. Григола Лорткипанидзе, 2б (Steps Batumi)",
          lat: 41.625_707,
          lng: 41.599_86,
      ...
      },
      {
        ...
        detailHref: "apartment.html",
        description:
          "Квартира-студия в жилом комплексе Steps Batumi. Адрес: Батуми, ул. Григола Лорткипанидзе, 2б. 11 этаж, 24 м². Новый бульвар: рядом парк имени Лех и Марии Качиньских, ТРЦ Metro City. Новый жилой комплекс бизнес-класса — ресепшн и круглосуточная охрана. Инфраструктура: ботанический сад, бизнес-центр, ресторан, гостиница, парковка, детская площадка, бассейн, сауна, хаммам, кафе, тренажёрный зал. До моря около 150 м, 4 скоростных лифта с автономным питанием, противопожарные комнаты безопасности с подачей кислорода. Подходит для проживания и для сдачи в аренду. Просторная светлая студия с качественным ремонтом, мебелью и техникой, вид на горы и город в сторону Турции, солнечная сторона. Цена $50 000 — уточняйте актуальность и условия сделки у менеджера.",
        priceGel: 135_000,
        priceKind: "fixed",
        geo: {
          address: "Батуми, ул. Григола Лорткипанидзе, 2б (Steps Batumi)",
      ...
      },
      {
        ...
        title: "Студия Tropical Garden",
        detailHref: "apartment.html",
        description:
          "Квартира-студия в жилом комплексе Tropical Garden, block B (Чакви). Адрес: Батуми, ул. Мездгваура, 41. 12 этаж, 35 м². Чакви, первая линия моря. Новый жилой дом: ухоженная территория, спортивная и детская площадки, сад, бассейн, SPA; в доме магазин и кафе. Надёжный застройщик, дом газифицирован, около 20 минут от центра Батуми, прописка в Батуми. Подходит для проживания и для сдачи в аренду. Полностью укомплектованная квартира с мебелью и техникой, хороший ремонт. Развитая инфраструктура: рядом детский сад, школа с русским сектором, парки, Ботанический сад, магазины. Охрана и противопожарная система, вид на море и Ботанический сад. Цена $70 000 — уточняйте актуальность и условия сделки у менеджера.",
        priceGel: 189_000,
        priceKind: "fixed",
        geo: {
          address: "Батуми, ул. Мездгваура, 41 (Tropical Garden, block B, Чакви)",
          lat: 41.714_513,
          lng: 41.723_939,
